...
def plot_modes_vtu(
    ...
    if isinstance(reference, StaticStructure):
        ...
        aero_ref: Optional[AeroSnapshot] = None
    else:
        struct_ref: StaticStructure = reference.structure
        aero_ref: Optional[AeroSnapshot] = reference.aero
