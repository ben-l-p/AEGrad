...
class BeamStructure(BaseBeamStructure):
    ...
    def static_adjoint(
        ...
        return StructuralDesignVariables(**dv.from_adjoint(f_shape, p_f_p_x - rhs), f_shape=f_shape)
    ...
    def dynamic_adjoint(
        ...
        def time_loop(
            ...
            jax_print("Solved adjoint for timestep {i_ts}", i_ts=i_ts, verbose_level=VerbosityLevel.NORMAL)
