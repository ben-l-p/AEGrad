...
from aegrad.models.pazy.base import make_generic_pazy_wing
from aegrad.models.pazy.straight.data.prepazy_properties import (
    PREPAZY_NO_SKIN,
    PREPAZY_WITH_SKIN,
)
from aegrad.models.pazy.straight.data.technion_pazy_properties import (
