...
from condor.utils.constants import BASE_SUMMATION_ORDER
from condor.utils.utils import conditional_profile

ADMode = Literal["reverse", "forward"]

if TYPE_CHECKING:
    from condor.aero.gradients.data_structures import AeroJacobianApproximations
    from condor.structure.gradients.data_structures import BeamJacobianApproximations
