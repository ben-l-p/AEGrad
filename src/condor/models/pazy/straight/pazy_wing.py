...
from condor.aero.flowfields import Constant, FlowField
from condor.coupled import CoupledAeroelastic
from condor.models.pazy.base import make_generic_pazy_wing
from condor.models.pazy.straight.data.prepazy_properties import (
    PREPAZY_NO_SKIN,
    PREPAZY_WITH_SKIN,
)
from condor.models.pazy.straight.data.technion_pazy_properties import (
