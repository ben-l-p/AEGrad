...
from condor.aero.data_structures import GridDiscretisation
from condor.aero.flowfields import FlowField
from condor.aero.utils import make_rectangular_grid
from condor.aero.uvlm import UVLM
from condor.algebra.so3 import vec_to_skew
from condor.coupled import CoupledAeroelastic
...
def make_generic_pazy_wing(
    ...
    # arclength midpoints of the condor elements, used for property interpolation
