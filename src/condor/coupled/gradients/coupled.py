...
from condor.algebra.base import ADMode
from condor.algebra.se3 import exp_se3
from condor.coupled import DynamicAeroelastic
...
from condor.structure import StructuralDesignVariables
from condor.structure.data_structures import OptionalJacobians, StructureMinimalStates
...
if TYPE_CHECKING:
    from condor.coupled.coupled import StaticAeroelastic
...
class CoupledAeroelastic(BaseCoupledAeroelastic):
    def _aeroelastic_states_res_from_dv_varphi(
        ...
        inner_case.set_design_variables(
            ...
            dt=self.aero.dt,
            x0_aero=dv.aero.zeta_b0
            if dv.aero.zeta_b0 is not None
            else self.aero.zeta_b0,
